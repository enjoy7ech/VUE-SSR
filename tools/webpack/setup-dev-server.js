...
const readFile = (fs, file, filePath = path.join(clientConfig.output.path, file)) => {
  try {
...
module.exports = function setupDevServer(app, templatePath, cb) {
  ...
  serverCompiler.watch({}, (err, stats) => {
    ...
    bundle = JSON.parse(
      readFile(mfs, 'vue-ssr-server-bundle.json', path.join(serverConfig.output.path, 'vue-ssr-server-bundle.json'))
    )
    update()
  })
  return readyPromise
